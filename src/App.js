    ...
    <div style={{ fontFamily: 'Arial, sans-serif', margin: 0, padding: 0 }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <h1 style={{ margin: 0, fontSize: '32px' }}>Tasos Tour</h1>
          <p style={{ margin: '10px 0 0' }}>Discover the Beauty of Athens with Our Expert Guides</p>
        </div>
      </header>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', display: 'flex', justifyContent: 'center' }}>
          <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex' }}>
            <li style={{ margin: '0 15px' }}><a href="#home" style={{ color: '#0072bb', textDecoration: 'none', fontWeight: 'bold' }}>Home</a></li>
            <li style={{ margin: '0 15px' }}><a href="#tours" style={{ color: '#0072bb', textDecoration: 'none', fontWeight: 'bold' }}>Tours</a></li>
            <li style={{ margin: '0 15px' }}><a href="#about" style={{ color: '#0072bb', textDecoration: 'none', fontWeight: 'bold' }}>About Us</a></li>
            <li style={{ margin: '0 15px' }}><a href="#booking" style={{ color: '#0072bb', textDecoration: 'none', fontWeight: 'bold' }}>Book Now</a></li>
            <li style={{ margin: '0 15px' }}><a href="#contact" style={{ color: '#0072bb', textDecoration: 'none', fontWeight: 'bold' }}>Contact</a></li>
          </ul>
        </div>
      </nav>
      ...
      <section id="home" style={{
        ...
        <div style={{ position: 'relative', maxWidth: '800px', padding: '0 20px' }}>
          <h2 style={{ fontSize: '48px', margin: '0 0 20px' }}>Experience Athens Like Never Before</h2>
      ...
      <section id="about" style={{ padding: '80px 20px', backgroundColor: '#f8f9fa' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <h2 style={{ textAlign: 'center', margin: '0 0 30px', fontSize: '36px', color: '#333' }}>About Us</h2>
          <p style={{ margin: '0 0 20px', lineHeight: '1.8', color: '#666', fontSize: '18px' }}>
            Tasos Tour was founded in 2010 by a group of passionate Athenian guides who wanted to share their love for their city with travelers from around the world.
          </p>
          <p style={{ margin: '0 0 20px', lineHeight: '1.8', color: '#666', fontSize: '18px' }}>
            Our tours are based on a "pay-what-you-want" model, meaning you decide what the tour was worth at the end. This ensures that our tours remain accessible to all travelers regardless of budget.
          </p>
          <p style={{ margin: '0 0 20px', lineHeight: '1.8', color: '#666', fontSize: '18px' }}>
            All our guides are licensed professionals with extensive knowledge of Athens' history, culture, and hidden gems. They are selected not only for their expertise but also for their passionate storytelling abilities.
          </p>
        </div>
      </section>
      ...
      <section id="booking" style={{ padding: '80px 20px', maxWidth: '800px', margin: '0 auto' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
            <div style={{ flex: '1 1 300px' }}>
              <label htmlFor="date" style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold', color: '#555' }}>Preferred Date *</label>
              <input
                type="date"
                id="date"
                name="date"
            ...
            <div style={{ flex: '1 1 300px' }}>
              <label htmlFor="tourType" style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold', color: '#555' }}>Tour Type *</label>
              <select
                id="tourType"
                name="tourType"
                required
          ...
          <div>
            <label htmlFor="participants" style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold', color: '#555' }}>Number of Participants *</label>
            <input
              type="number"
              id="participants"
              name="participants"
          ...
          <div>
            <label htmlFor="message" style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold', color: '#555' }}>Additional Information</label>
            <textarea
              id="message"
              name="message"
              rows="4"
      ...
      <section style={{ padding: '80px 20px', backgroundColor: '#f8f9fa' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '30px' }}>
            {/* Testimonial 1 */}
            <div style={{ flex: '1 1 300px', maxWidth: '350px', padding: '30px', backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}>
              <p style={{ fontSize: '18px', fontStyle: 'italic', marginBottom: '20px', color: '#666' }}>
                "The Classical Athens Tour was absolutely amazing! Our guide Maria was knowledgeable, funny, and made the history come alive. Highly recommended!"
              </p>
            ...
            <div style={{ flex: '1 1 300px', maxWidth: '350px', padding: '30px', backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}>
              <p style={{ fontSize: '18px', fontStyle: 'italic', marginBottom: '20px', color: '#666' }}>
                "The Street Art Tour showed us a completely different side of Athens that we would have missed otherwise. Dimitris was passionate and engaging throughout."
              </p>
            ...
            <div style={{ flex: '1 1 300px', maxWidth: '350px', padding: '30px', backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}>
              <p style={{ fontSize: '18px', fontStyle: 'italic', marginBottom: '20px', color: '#666' }}>
                "The Food & Culture Tour was the highlight of our trip to Athens! We tried so many delicious foods and learned about Greek traditions. Worth every penny!"
              </p>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '30px', flexWrap: 'wrap', marginBottom: '40px' }}>
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ margin: '5px 0 0', color: '#666' }}>info@athensfreetour.com</p>
            </div>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ margin: '5px 0 0', color: '#666' }}>Syntagma Square, Athens</p>
            </div>
          </div>
